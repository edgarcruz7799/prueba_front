...
<div class="col-sm-12 container contenido">
  ...
  <div class="sup navv">
      <ul class="nav nav-tabs">
        ...
        <li id="livr" class="active" onclick="mostrar('vr'); mostrarli('livr')"><a href="#"><b><?php echo $t->_("Value_Collected") ?></b></a></li>
        <li id="licl" onclick="mostrar('cl'); mostrarli('licl')"><a href="#"><b><?php echo $t->_("customers") ?></b></a></li>
      </ul>
  </div>
