...
<div class="col-sm-12 container contenido">
  ...
  <div class="sup navv">
      <ul class="nav nav-tabs">
        <li class="active" onclick="mostrar('nt')" ><a href="#"><b><?php echo $t->_("No_Transactions") ?></b></a></li>
        <!-- <li onclick="mostrar('vr')" ><a href="#"><b><?php echo $t->_("Value_Collected") ?></b></a></li>
        <li onclick="mostrar('cl')" ><a href="#"><b><?php echo $t->_("customers") ?></b></a></li> -->
      </ul>
  </div>
...
<div id="nt" style="display: block;" class="trans col-sm-11">
    ...
    <div class="col-sm-12">    
        <div class="row col-sm-12 pull-right">
            ...
            <li style=""><a id="select1" href="{{url('transaction/reports?search=1')}}"><b><?php echo $t->_("Today") ?></b></a></li>
            <li class="activesegselect" style=""><a id="select2" href="{{url('transaction/reports?search=2')}}"><b><?php echo $t->_("Last_7_days") ?></b></a></li>
            <li style=""><a id="select3" href="{{url('transaction/reports?search=3')}}"><b><?php echo $t->_("Last_30_days") ?></b></a></li>
            <li style=""><a href="#" id="buscarPersonalizado"><b><?php echo $t->_("Personalized") ?></b></a>
            </li>
            </ul>
            </div>
...
<div id="cl" style="display: none;" class="trans col-sm-11">
     ...
     <div id="notrans" class="vall row col-sm-6">
        <div class="col-sm-12">
            <img src="{{url('img/repetir.svg')}}">
            <span id="notransaccionh"><b>{{dato.total_ammount}}</b><b id="cop"><?php echo $t->_("Clientes") ?></b></span> 
            <!-- <p id="p2"><b style="color: red;">12%</b><?php echo $t->_("Since_last_week") ?></p> -->
        </div>
    </div>
