...
<div class="col-sm-12 container contenido">
  ...
  <div class="sup navv">
      <ul class="nav nav-tabs">
        <li id="lint" onclick="mostrar('nt'); mostrarli('lint')"><a href="#"><b><?php echo $t->_("No_Transactions") ?></b></a></li>
        <li id="livr" onclick="mostrar('vr'); mostrarli('livr')"><a href="#"><b><?php echo $t->_("Value_Collected") ?></b></a></li>
        <li id="licl" class="active" onclick="mostrar('cl'); mostrarli('licl')"><a href="#"><b><?php echo $t->_("customers") ?></b></a></li>
      </ul>
  </div>
...
<div id="vr" style="display: block;" class="trans col-sm-11">
    ...
    <div class="col-sm-12">
     ...
     <div class="row distmap col-sm-12" id="canvas-holder" style="margin-top: 2%;">
       <canvas id="valor-recaudo" width="600" height="150"></canvas>
     </div>
...
<div id="cl" style="display: block;" class="trans col-sm-11">
    ...
    <div class="col-sm-12">
     ...
     <div class="row distmap col-sm-12" id="canvas-holder" style="margin-top: 2%;">
       <canvas id="cliente" width="600" height="150"></canvas>
     </div>
