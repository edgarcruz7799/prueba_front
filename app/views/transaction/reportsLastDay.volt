...
<div class="col-md-6" style="">
    <h4 class="section-title h4_index"> ULTIMOS 7 días de <span>RESERVAS</span> </h4>
</div>
        ...
        <div class="row col-sm-12 pull-right">
            <div class="row">
                ...
                <ul class="nav nav-tabs pull-right">
                    ...
                    <li class="activesegselect" style=""><a id="select2" style="color:#f71e14" href="{{url('transaction/reportsLastDay')}}"><b><?php echo $t->_("Last_7_days") ?></b></a></li>
