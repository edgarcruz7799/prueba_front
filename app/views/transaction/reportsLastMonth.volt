...
<div class="col-md-6" style="">
    <h4 class="section-title h4_index"> ULTIMOS 30 días de <span>RESERVAS</span> </h4>
</div>
        ...
        <div class="row col-sm-12 pull-right">
            <div class="row">
                ...
                <ul class="nav nav-tabs pull-right">
                    ...
                    <li style=""><a id="select3" style="color:#f71e14" href="{{url('transaction/reportsLastMonth')}}"><b><?php echo $t->_("Last_30_days") ?></b></a></li>
