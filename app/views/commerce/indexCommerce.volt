...
<div class="col-md-6" style="">
    ...
    <p class="section-text p_index"><?php echo $t->_("textWelcomeCommerce_1") ?><br><?php echo $t->_("textWelcomeCommerce_2") ?></p>
</div>

<!--Fila Banner General============================================-->  
<div class="col-md-6 boxcommerce">
    <div class="row">
        <div id="div_box_blue" class="col-md-5 col-sm-6 col-xs-12 divcaja1">
            <!---Pagar Articuloso servicios-->
            <div class="card alt">
                <a href="{{url('transaction/consulttransaction')}}">
                    ...
                    <div class="card-body">
                        <p><?php echo $t->_("titleSectionCentralCommerce") ?></p>                  
                    </div>
                </a>
            </div>
        </div>
        <div id="div_box_white" class="col-md-5 col-sm-6 col-xs-12">
            <!---Webs that accept .. -->
            <div class="card">
                <a style="color: #005eae;" href="{{url('register/integrationdata')}}">
                    <div class="card-header">
                        <figure>
                    ...
                    <div class="card-body">
                       <p style="color: #e2251c;"><?php echo $t->_("titleSectionRightCommerce_1") ?><br><?php echo $t->_("titleSectionRightCommerce_2") ?></p>
                    </div>
                </a>
            </div>
        </div>
...
<div class="col-sm-12 container contenido">
  ...
  <div class="sup navv">
      <ul class="nav nav-tabs">
        ...
        <li id="livr" onclick="mostrar('vr'); mostrarli('livr')"><a ><b><?php echo $t->_("Value_Collected") ?></b></a></li>
        <li id="licl" onclick="mostrar('cl'); mostrarli('licl')"><a ><b><?php echo $t->_("customers") ?></b></a></li>
      </ul>
  </div>
...
<div id="cl" style="display: block;" class="trans col-sm-11">
    ...
    <div id="notrans" class="vall row col-sm-6">
        <div class="col-sm-12">
            <img src="{{url('img/repetir.svg')}}">
            <span id="notransaccionh"><b>{{ dato.total_ammount }}</b><b id="cop">Clientes</b></span>
            <!-- <p id="p2"><b style="color: red;">12%</b><?php echo $t->_("Since_last_week") ?></p> -->
        </div>
    </div>
