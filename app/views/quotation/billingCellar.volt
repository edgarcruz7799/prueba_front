			...
			<div id	="divboxtres" class="col-md-12 box_facturacion">
				...
				<div style="">
					...
					<div class="col-md-12" style="display: flex;">
						...
						<label style="text-align: right;">
							{{ dato.space_require }} m<sup>2</sup>
						</label>
					</div>
					<div class="col-md-12" style="display: flex;">
						<label>
				...
				<form id="formbrinks" action="https://gatewaycashco.logisticappweb.com/" method="POST" target="_blank">
					<input type="hidden" name="amount" value="{{ dato.amount }}">
					<input type="hidden" name="commerce_id" value="59">
					...
					<input type="hidden" name="address" value="{{dato.address}}">
